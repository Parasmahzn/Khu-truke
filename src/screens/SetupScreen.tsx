...
type SetupScreenProps = { onDone: (name: string, currencyCode: string) => void };
        ...
        <View style={styles.currencyRow}>
          {CURRENCIES.map((c) => {
            ...
            return (
              ...
              >
                <Text style={[styles.currencySymbol, active && styles.activeText]}>
                  {c.symbol}
                </Text>
                <Text style={[styles.currencyCode, active && styles.activeText]}>
                  {c.code}
                </Text>
              </Pressable>
            );
...
const makeStyles = (C: Colors) => StyleSheet.create({
  ...
  currencyChip: {
    ...
    borderWidth: 1.5, borderColor: C.ink, borderRadius: RADIUS.pill,
    backgroundColor: C.white,
  },
  currencyChipActive: {
